...
namespace BankSystem.Reports
{
    public class clsInitializeBalanceStatementReport
    {
        ...
        public void LoadManageRecor dsControl()
        {
            _RecordsManager.__UpdateBtn.Visible = false;
            _RecordsManager.__AddNewBtn.Visible = false;

            _RecordsManager.__HeaderImg.Image = Resources.Team;//change image

            _RecordsManager.__Initi alize(_FilterBy_Options(), clsPerson.FilterPeople, _ContextMenuPackage(), _FilterByGroups());
        ...
        private Dictionary<string, string> _FilterBy_Options()
        {
            Dictionary<string, string> Options = new Dictionary<string, string>
            {
                ...
                {"activeaccounts","Active Accounts Count"},
        ...
        private Dictionary<string, Dictionary<string, string>> _FilterByGroups()
        {
            ...
            var lastActivityDate = new Dictionary<string, string>
            {
                { "All", "" },
            ...
            var FilterOptions = new Dictionary<string, Dictionary<string, string>>
            {
                {
                    "customerstatus", new Dictionary<string, string>
                    {
                        { "All", "" },
                        { "Active", "1" },
                        { "Inactive", "0" }
        ...
        private void _ConfigureDataRecordsContainer()
        {
            ...
            _RecordsManager.__RecordsContainer.Columns["CustomerReportsID"].HeaderText = "Customer Reports ID";
