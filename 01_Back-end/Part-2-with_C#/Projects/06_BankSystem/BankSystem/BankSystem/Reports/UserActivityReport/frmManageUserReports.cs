...
using BankSystem.Reports.UserActivityReport;
...
namespace BankSystem.Reports.UserReport
{
    public partial class frmManageUserReports : Form
    {
        ...
        public void LoadManageRecordsControl()
        {
            ...
            ctrlManageRecords1.__CloseFormDelegate += ()=> this.Close();
        ...
        {
            return clsUtil_BL.MappingHelper.GetOptionsFromMapping(typeof(clsAuditUserActions.Filter_Mapping));
        }
        private Dictionary<string, Dictionary<string, string>> _FilterByGroups()
        {
            return clsUtil_BL.MappingHelper.FilterBy_Groups(typeof(clsAuditUserActions.Filter_ByGroupsMapping));
        }
        ...
        void _ContextMenuViewReportCard(int ReportID, ToolStripMenuItem menuItem)
        {
            ...
            if (userActions != null)
            {
                frmUserReportCard card = new frmUserReportCard(userActions);
                card.ShowDialog();
            }
            else
