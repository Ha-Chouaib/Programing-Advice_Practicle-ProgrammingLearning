...
//Write a program to calcilate your age in days.
...
int GetYourAgeByDays(stDate Date)
{   
    stDate CurrentDate=GetCurrentDate();
    return DiffDaysBetweenTowDates(Date,CurrentDate);
...
int main()
{
    ...
    int AgeByDays=GetYourAgeByDays(Date);
    printf("Your Age by Days is [%d]\n",AgeByDays);
