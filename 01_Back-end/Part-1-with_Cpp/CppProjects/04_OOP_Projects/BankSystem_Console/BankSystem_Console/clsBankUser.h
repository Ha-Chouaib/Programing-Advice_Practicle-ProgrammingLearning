...
class clsBankUser : public clsPerson
{
    ...
    {
        fstream Reg;
        Reg.open("LoginRegister.txt", ios::out | ios::app);
        if (Reg.is_open())
        {
            Reg << Data << endl;
        }
    ...
    static vector<clsBankUser> _LoadUserDataFromFile()
    {
        ...
        fstream Data;
        Data.open("UsersData.txt", ios::in);
        if (Data.is_open())
        {
            string Line;
    ...
    {
        fstream Data;
        Data.open("UsersData.txt", ios::out);
        if (Data.is_open())
        {
            string Line;
    ...
    {
        fstream Data;
        Data.open("UsersData.txt", ios::out | ios::app);
        if (Data.is_open())
        {
            Data << DataLine << endl;
        }
...
private:
    ...
    {
        fstream Hist;
        Hist.open("TransfersLogHistory.txt", ios::out | ios::app);
        if (Hist.is_open())
        {
            Hist << Line << endl;
        }
    ...
    static vector<stTransfersHistory> _LoadTransfersHistoryFromFile()
    {
        ...
        fstream TransFile;
        TransFile.open("TransfersLogHistory.txt", ios::in);
...
public:
    ...
    static vector<stLogHistData> _GetHistoryLogingData()
    {
        ...
        fstream Hist;
        Hist.open("LoginRegister.txt", ios::in);
        if (Hist.is_open())
        {
            string Line;
    ...
    static clsBankUser Find(string UserName)
    {
        ...
        fstream UsersData;
        UsersData.open("UsersData.txt", ios::in);
    ...
    static clsBankUser Find(string UserName, string PassWord)
    {
        ...
        fstream ClientsData;
        ClientsData.open("UsersData.txt", ios::in);
