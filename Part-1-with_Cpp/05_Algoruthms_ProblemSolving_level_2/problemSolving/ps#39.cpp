...
//write a prgram copy just the prime numbers within a random array.
...
void CopyPrimeNumbers(int OriginalArr[100],int CopyArr[100] ,int arr1Length, int& arr2Length)
{
    for(int i=0; i<arr1Length; i++)
    {   
        if(IsPrime(OriginalArr[i])== enPrimeOrNot::Prinme)
...
{   
    ...
    cout<<"The Array[2] Prime number(s): ";
