...
namespace _04_2_AlgorithmToSearchInBST
{
    ...
    public class BinarySearchTree<T> where T : IComparable<T>
    {
        ...
        private BinarySearchTreeNode<T> Find (BinarySearchTreeNode<T> node, T Value)
        {
                ...
                if (node == null || Value.CompareTo(node.Value) == 0) return node;
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Does The BST Contains 10? [ {bst.Find(10)} ]");
            Console.WriteLine($"Does The BST Contains 100? [ {bst.Find(100)} ]");
