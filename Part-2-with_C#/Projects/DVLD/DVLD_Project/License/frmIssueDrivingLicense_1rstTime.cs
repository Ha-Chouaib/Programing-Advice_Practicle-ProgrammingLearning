...
namespace DVLD_Project.License
{
    public partial class frmIssueDrivingLicense_1rstTime : Form
    {
        ...
        private bool _SaveNewLicense()
        {
            ...
            clsMainApplication MainApplication = clsMainApplication.Find(LocalLicenseApp.MainApplicationID);
            clsDrivers Driver;

            bool IsNewDriver=true;
            if (clsDrivers.Exist(MainApplication.ApplicantPersonID))
            {
                Driver = clsDrivers.Find(MainApplication.ApplicantPersonID);
                IsNewDriver = false;
            }
            else
            {
                Driver = new clsDrivers();
                Driver._PersonID = MainApplication.ApplicantPersonID;
            ...
            NewLicense.ApplicationID = MainApplication.AppID;
            ...
            NewLicense.IssueReason = 1;// First Time Got This License
            ...
            {
                MainApplication.AppStatus = clsGlobal.ApplicationStatus_Complete;
