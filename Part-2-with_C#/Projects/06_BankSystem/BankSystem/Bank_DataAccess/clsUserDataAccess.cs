...
namespace Bank_DataAccess
{
    public class clsUserDataAccess
    {
        ...
        public static int AddNewUser(int PersonID,string UserName,DateTime CreatedDate,string Role ,string Password, bool IsActive, int CreatedByUserID)
        {
        ...
        public  static bool FindUserByID(int UserID ,ref int PersonID,ref string UserName,ref DateTime CreatedDate,ref string Role,ref string Password,ref bool IsActive,ref int CreatedByUserID)
        {
        ...
        public static bool FindUserByPersonID(int PersonID, ref int UserID , ref string UserName, ref DateTime CreatedDate, ref string Role, ref string Password, ref bool IsActive, ref int CreatedByUserID)
        {
        ...
        public static bool FindUserByName(string UserName , ref int UserID, ref int PersonID, ref DateTime CreatedDate, ref string Role, ref string Password, ref bool IsActive, ref int CreatedByUserID)
        {
        ...
        {
            string Query = "Sp_UpdateUserState";
            bool success = false;
            try
            {
                using (SqlConnection connection = new SqlConnection(DataAccessSettings.connectionString))
